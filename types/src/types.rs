...
pub mod mock {
    ...
    impl AudioInterface for MockAudioInterface {
        async fn create_stream(&self, _: CreateStreamRequest) -> Result<CreateStreamResponse> {
            match self.error {
                Some(err) => Err(Error::msg(err)),
                None => Ok(Default::default()),
            }
        }

        async fn delete_stream(&self, _: DeleteStreamRequest) -> Result<DeleteStreamResponse> {
            match self.error {
                Some(err) => Err(Error::msg(err)),
                None => Ok(Default::default()),
            }
        ...
        async fn get_device_info(&self, _: GetDeviceInfoRequest) -> Result<GetDeviceInfoResponse> {
            match self.error {
                Some(err) => Err(Error::msg(err)),
                None => Ok(Default::default()),
            }
        ...
        async fn list_streams(&self, _: ListStreamsRequest) -> Result<ListStreamsResponse> {
            match self.error {
                Some(err) => Err(Error::msg(err)),
                None => Ok(Default::default()),
            }
